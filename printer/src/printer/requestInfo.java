...
public class requestInfo extends javax.swing.JFrame {
    ...
    public requestInfo(int id,String password) {
        initComponents();
        this.id=id;
        this.password=password;
        try {
            information.setText(adminObject.getRequest(id, password));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(information, javax.swing.GroupLayout.PREFERRED_SIZE, 372, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(requestInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
